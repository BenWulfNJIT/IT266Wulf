...
// The default values for player movement cvars are set in def/player.def
																//default 48
idCVar pm_jumpheight(				"pm_jumpheight",			"300",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "approximate hieght the player can jump" );
...
// RAVEN BEGIN
																//default 250
idCVar pm_speed(					"pm_speed",					"500",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while running" );
...
// RAVEN END													default walkspeed = 80
